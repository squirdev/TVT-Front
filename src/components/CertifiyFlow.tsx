...
export default function CertifyFlow(props: any) {
    ...
    return (
        <div className="relative w-[552px] h-[300px] bg-[#f0eff0]  border border-solid border-[#d6d5da] dark:bg-black dark:border-white   dark:border-opacity-10 rounded-[20px] overflow-hidden p-[16px]">
            <div className="absolute top-[49px] left-[119px] z-20 flex flex-col items-center justify-center bg-[#0B0B0B] rounded-full border-[1px] border-[#fff] border-opacity-10 w-[85px] h-[35px] text-[12px] font-[500] text-white">
                Provider
            </div>
            <img src={Line1Img} alt="line" className="absolute top-[78px] left-[157px] z-10" />
            ...
            }} alt="tvt" className="absolute top-[85px] left-[228px] z-20" />
            <img src={Line3Img} alt="line" className="absolute top-[58px] right-[135px] z-10" />
            <div className="absolute bottom-[105px] left-[77px] z-20 flex flex-col items-center justify-center bg-[#0B0B0B] rounded-full border-[1px] border-[#fff] border-opacity-10 w-[85px] h-[35px] text-[12px] font-[500] text-white">
                Company
            </div>
